...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CartItem.player_number'
        db.add_column(u'shop_cartitem', u'player_number',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=0, blank=True),
                      keep_default=False)

        # Adding field 'OrderItem.player_number'
        db.add_column(u'shop_orderitem', u'player_number',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=0, blank=True),
                      keep_default=False)

        # Adding field 'Product.require_number'
        db.add_column(u'shop_product', u'require_number',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CartItem.player_number'
        db.delete_column(u'shop_cartitem', u'player_number')

        # Deleting field 'OrderItem.player_number'
        db.delete_column(u'shop_orderitem', u'player_number')

        # Deleting field 'Product.require_number'
        db.delete_column(u'shop_product', u'require_number')
    ...
    models = {
        ...
        u'shop.cartitem': {
            ...
            u'player_number': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '2', 'decimal_places': '0', 'blank': 'True'}),
        ...
        u'shop.product': {
            ...
            u'require_number': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
